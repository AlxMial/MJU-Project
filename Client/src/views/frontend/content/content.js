            ...
            <div className="container pt-20 px-12 relative mx-auto lg:w-10/12 flex flex-wrap">
                ...
                <div className='w-full mt-3'>
                    <div className="min-h-screen-35 px-4 py-4 relative flex flex-col min-h-3 break-words bg-white w-full mb-6 rounded-lg shadow-lg">
                        <div className='w-full lg:w-10/12 text-sm font-bold mx-auto mt-3 mb-3'> {subjectDataTemp.SubjectNameTH} </div>
                        ...
                        <div className='course-content lg:w-10/12 leading-none mx-auto py-3 mb-3'>
                            {subjectDataTemp.ContentTH}
                        </div>
                        <div className='font-bold title-att w-full lg:w-10/12 mx-auto mb-1'>ไฟล์แนบ</div>
                        <div className='file-content lg:w-10/12 mx-auto mb-3'>
                            {
                                attachData.map(item => {
                                    return (
                                        <div className='flex flex-wrap mb-2 py-1 attach-list' key={item.id}>
                                            <Link to="" target="_blank" className='linkDownload px-2 mr-2' download>
                                                <span><i class="fas fa-download"></i> </span> ดาวน์โหลด</Link>
                                            <i className={setFileType(item.FileType)}></i>
                                            <div className='attach-list-name px-2'>{item.FileName}</div>
                                        </div>
                                    )
                                })
                            }
